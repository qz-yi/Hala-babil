            ...
            <View style={styles.commentItem}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      ACCENT_COLORS[item.userId.length % ACCENT_COLORS.length],
                  },
                ]}
              >
                {item.userAvatar ? (
              ...
              <View style={styles.commentBody}>
                <Text style={[styles.commentUser, { color: colors.tint }]}>
                  {item.userName}
                </Text>
            ...
            >
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      ACCENT_COLORS[item.id.length % ACCENT_COLORS.length],
                  },
                ]}
              >
                {item.avatar ? (
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Ionicons
            name={videoUri ? "checkmark-circle" : "videocam-outline"}
            size={28}
            color={videoUri ? colors.tint : colors.textSecondary}
          />
          <Text
            style={[
              styles.videoPickText,
              { color: videoUri ? colors.tint : colors.textSecondary },
            ]}
          >
          ...
          {FILTERS.map((f) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor:
                    filter === f.key ? colors.tint : colors.backgroundTertiary,
                  borderColor:
                    filter === f.key ? colors.tint : colors.border,
                },
              ]}
            >
              <Text
        ...
        <View style={styles.publishBtns}>
          <TouchableOpacity
            onPress={handleClose}
            style={[styles.cancelPub, { borderColor: colors.border }]}
          >
            <Text
              style={{
                color: colors.textSecondary,
      ...
      >
        ...
        <TouchableOpacity onPress={() => setShowPublish(true)}>
          ...
          >
            ...
            <Text style={styles.emptyBtnText}>نشر أول مقطع</Text>
          </LinearGradient>
        </TouchableOpacity>
        <PublishModal
          visible={showPublish}
