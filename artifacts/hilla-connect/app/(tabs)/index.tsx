            ...
            return (
              <View
                ...
                style={[
                  styles.seat,
                  {
                    backgroundColor: user ? `${accentColor}33` : colors.backgroundTertiary,
...
export default function HomeScreen() {
  const { rooms, currentUser, isSuperAdmin, createRoom, deleteRoom, t, theme } = useApp();
...
const styles = StyleSheet.create({
  ...
  headerName: { fontSize: 22, fontFamily: "Inter_700Bold", flex: 1 },
  adminBtn: {
